...
<head>
    ...
    <title>Login | Money Logger</title>
    ...
    <div class="flex h-full">
        ...
        <div class="my-auto w-1/2">
            <div class="mb-24 flex justify-center">
                <h1 class="text-primary text-4xl">Login Money Logger</h1>
            </div>
            <form action="/login" method="post">
                ...
                <div class="mx-auto flex w-1/2 justify-center">
                    <button type="submit"
                        class="bg-primary hover:text-primary hover:border-primary w-3/4 rounded-2xl border py-4 text-white hover:bg-white">Login</button>
                </div>
            </form>
        </div>
    </div>
